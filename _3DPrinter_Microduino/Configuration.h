...
#define STRING_CONFIG_H_AUTHOR "(Microduino)" // Who made the changes.
...
// 80 = Rumba
// 9  = Gen3+
//29 = Microduino Compatible

#ifndef MOTHERBOARD
#define MOTHERBOARD 29
#endif
...
#define PID_MAX 255 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define PID_dT ((16.0 * 8.0)/(F_CPU / 64.0 / 256.0)) //sampling period of the temperature routine
    ...
    #define  DEFAULT_Kp 58.13
    #define  DEFAULT_Ki 5.44
    #define  DEFAULT_Kd 155.25
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,407,95}  // default steps per unit for Ultimaker
...
//#define DOGLCD  // Support for SPI LCD 128x64
...
#define MICRODUINO_FULL_GRAPHIC_SMART_CONTROLLER
//#define encoderSensitive  //Make the encoder more sensitive
#define LCD_SLEEP_TIMEOUT 30000  //oled sleep time,normal:30 seconds

#if defined (MICRODUINO_FULL_GRAPHIC_SMART_CONTROLLER)
 #define DOGLCD
